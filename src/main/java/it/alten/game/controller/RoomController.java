...
import static it.alten.game.model.enums.Direction.NORTH;
...
public class RoomController {
    ...
    private Room createMap() {
        ...
        connectRooms(entrance,bossRoom, NORTH);
        return entrance;
    }

    private void connectRooms(Room room1, Room room2, Direction direction1, Direction direction2){
